                        ...
                        <div class="col-span-12 mt-8">
                            <div class="intro-y flex items-center h-10">
                                ...
                                <a href="" class="ml-auto flex items-center text-primary"> <i data-lucide="refresh-ccw"
                                        class="w-4 h-4 mr-3"></i> Tải lại trang </a>
                            </div>
                                ...
                                <div class="col-span-12 sm:col-span-6 xl:col-span-3 intro-y">
                                    <div class="report-box zoom-in">
                                        <div class="box p-5">
                                            ...
                                            <div class="text-base text-slate-500 mt-1">Bán hàng</div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-span-12 sm:col-span-6 xl:col-span-3 intro-y">
                        ...
                        <div class="col-span-12 mt-6">
                            ...
                            <div class="intro-y overflow-auto lg:overflow-visible mt-8 sm:mt-0">
                                <table class="table table-report sm:mt-2">
                                    <thead>
                                        <tr>
                                            <th class="whitespace-nowrap">Hình</th>
                                    ...
                                    <tbody>
                                            ...
                                            <td class="w-40">
                                                <div class="flex">
                                                    <img alt="Midone - HTML Admin Template" class="tooltip rounded-full"
                                                        ...
                                                        title="Uploaded at 3 July 2022">
                                                </div>
                                            </td>
                                            <td>
                                                <a href="" class="font-medium whitespace-nowrap">Quần Đùi</a>
                                                <div class="text-slate-500 text-xs whitespace-nowrap mt-0.5">Mặc rất là
                                                    mátt</div>
                                            </td>
                                            <td class="text-center">9</td>
                                            <td class="w-40">
                                                <div class="flex items-center justify-center text-success"> <i
                                                        data-lucide="check-square" class="w-4 h-4 mr-2"></i> Còn hàng
                                                </div>
                                            </td>
                                        ...
                                        <tr class="intro-x">
                                            ...
                                            <td>
                                                <a href="" class="font-medium whitespace-nowrap">Quần Đùi</a>
                                                <div class="text-slate-500 text-xs whitespace-nowrap mt-0.5">Mặc rất
                                                    máttt</div>
                                            </td>
                        ...
                        <div class="2xl:pl-6 grid grid-cols-12 gap-x-6 2xl:gap-x-0 gap-y-6">
                            ...
                            <div class="col-span-12 md:col-span-6 xl:col-span-4 2xl:col-span-12 mt-3 2xl:mt-8">
                                ...
                                <div class="mt-5">
                                    <div class="intro-x">
                                        <div class="box px-5 py-3 mb-3 flex items-center zoom-in">
                                            ...
                                            <div class="ml-4 mr-auto">
                                                <div class="font-medium">Huỳnh Ngọc Tài</div>
                                                <div class="text-slate-500 text-xs mt-0.5">12/11/2022</div>
                                            </div>
                                            <div class="text-success">+20.000đ</div>
                                        </div>
                                    </div>
                                    <div class="intro-x">
                                        <div class="box px-5 py-3 mb-3 flex items-center zoom-in">
                                            ...
                                            <div class="text-success">+70.000đ</div>
                                        </div>
                                    </div>
                                    <div class="intro-x">
                                        <div class="box px-5 py-3 mb-3 flex items-center zoom-in">
                                            ...
                                            <div class="text-success">+90.000đ</div>
                                        </div>
                                    </div>
                                    <div class="intro-x">
                                        <div class="box px-5 py-3 mb-3 flex items-center zoom-in">
                                    ...
                                    <a href=""
                                        class="intro-x w-full block text-center rounded-md py-3 border border-dotted border-slate-400 dark:border-darkmode-300 text-slate-500">xem
                                        chi tiết</a>
                                </div>
                            </div>
                            <!-- END: Transactions -->
